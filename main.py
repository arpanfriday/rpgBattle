...
enemy1 = Person("Imp  ", 300, 20, 155, 125, [], [])
enemy2 = Person("Magus", 1200, 65, 145, 25, [], [])
enemy3 = Person("Imp  ", 300, 20, 155, 125, [], [])
...
while running:
    ...
    print("Enemy attacks for", enemy_dmg, "points of damage to " + players[target].name.replace(" ", ""))
